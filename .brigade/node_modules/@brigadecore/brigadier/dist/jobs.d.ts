 ...
 * Job.sequence method.
 */
export declare class Job implements Runnable {
    /** The name of the job. */
    name: string;
     ...
     * @param event The event that triggered the job
     */
    static container(name: string, image: string, event: Event): Job;
    /**
     ...
     */
    static sequence(...runnables: Runnable[]): SerialGroup;
    /**
     * Specifies a Runnable composed of sub-Runnables (such as jobs
     ...
     */
    static concurrent(...runnables: Runnable[]): ConcurrentGroup;
}
/**
